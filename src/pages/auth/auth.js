...
import { createUserDocument, getUserProfile, updateUserSettings } from "../../firestore.js";
  ...
  if (user) {
    ...
    try {
      ...
      if (profile && profile.settings && typeof profile.settings.darkMode !== "undefined") {
        ...
        const currentLocalDark = document.documentElement.classList.contains("dark-theme") || document.documentElement.dataset.theme === "dark" || (document.body && document.body.classList.contains("dark-theme"));
    ...
    if (userMenu) {
      ...
      if (avatarEl) {
        ...
        avatar.src = user.photoURL || "/src/assets/images/default-avatar.svg";
        avatar.alt = displayName;
        avatar.referrerPolicy = "no-referrer";
        avatarEl.replaceChildren(avatar);
      }
...
async function handleRegister(e) {
  ...
  try {
    // Firebase Auth enforces uniqueness for the synthetic username email.
